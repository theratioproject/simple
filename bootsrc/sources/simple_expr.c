	...
	*/
	...
	if ( simple_parser_isoperator2(parser,OP_FOPEN) ) {
		...
		if ( simple_parser_icg_getlastoperation(parser) == ICO_LOADADDRESS ) {
			...
			simple_list_deleteitem_gc(parser->pSimpleState,simple_parser_icg_getactiveoperation(parser),3);
		}
			...
			simple_list_deleteitem_gc(parser->pSimpleState,simple_parser_icg_getactiveoperation(parser),4);
			simple_list_deleteitem_gc(parser->pSimpleState,simple_parser_icg_getactiveoperation(parser),3);
			nCallMethod = 1 ;
		}
		simple_parser_nexttoken(parser);
