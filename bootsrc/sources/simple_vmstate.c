...
{
	List *pThis  ;
	pList = simple_list_newlist_gc(vm->pSimpleState,pList);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pMem));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pFuncCallList));
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nFuncExecute);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nSP);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nFuncSP);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pObjState));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aBraceObjects));
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->pBraceObject);
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->cFileName);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aPCBlockFlag));
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nBlockFlag);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aScopeNewObj));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aActiveModules));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aScopeID));
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nActiveScopeID);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pExitMark));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pLoopMark));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pTry));
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->pActiveMem);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nListStart);
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->pNestedLists);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nInsideBraceFlag);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aForStep));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->aBeforeObjState));
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->aPCBlockFlag);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nLineNumber);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nInClassRegion);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nPrivateFlag);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nGetSetProperty);
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->pGetSetObject);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nGetSetObjType);
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->pAssignment);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nBeforeEqual);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nNOAssignment);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nFuncExecute2);
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nCallClassInit);
	simple_list_addpointer_gc(vm->pSimpleState,pList,vm->aLoadAddressScope);
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getsize(vm->pLoadAddressScope));
	/* Save This variable */
	pThis = simple_list_getlist(simple_vm_getglobalscope(vm),SIMPLE_VM_STATICVAR_THIS) ;
	simple_list_addpointer_gc(vm->pSimpleState,pList,simple_list_getpointer(pThis,SIMPLE_VAR_VALUE));
	simple_list_addint_gc(vm->pSimpleState,pList,simple_list_getint(pThis,SIMPLE_VAR_PVALUETYPE));
	simple_list_addint_gc(vm->pSimpleState,pList,vm->nCurrentGlobalScope);
}
...
void simple_vm_restorestate ( VM *vm,List *pList,int nPos,int nFlag )
{
	...
	*/
	...
	pThis = simple_list_getlist(simple_vm_getglobalscope(vm),SIMPLE_VM_STATICVAR_THIS) ;
	simple_list_setpointer_gc(vm->pSimpleState,pThis,SIMPLE_VAR_VALUE,simple_list_getpointer(pList,39));
	simple_list_setint_gc(vm->pSimpleState,pThis,SIMPLE_VAR_PVALUETYPE,simple_list_getint(pList,40));
}
...
void simple_vm_restorestate2 ( VM *vm,List *pList,int x )
{
	...
	/* Restore This variable */
	pThis = simple_list_getlist(simple_vm_getglobalscope(vm),SIMPLE_VM_STATICVAR_THIS) ;
	simple_list_setpointer_gc(vm->pSimpleState,pThis,SIMPLE_VAR_VALUE,simple_list_getpointer(pList,x+28));
	simple_list_setint_gc(vm->pSimpleState,pThis,SIMPLE_VAR_PVALUETYPE,simple_list_getint(pList,x+29));
	/* Update Self Object if we are inside braces */
	if ( simple_list_getsize(vm->aBraceObjects) > 0 ) {
		simple_vm_oop_updateselfpointer2(vm,(List *) simple_list_getpointer(simple_list_getlist(vm->aBraceObjects,simple_list_getsize(vm->aBraceObjects)),1));
	}
...
void simple_vm_backstate ( VM *vm,int x,List *pList )
{
	...
	if ( x < simple_list_getsize(pList) ) {
		...
		for ( y = x + 1 ; y <= nLimit ; y++ ) {
			simple_list_deleteitem_gc(vm->pSimpleState,pList,simple_list_getsize(pList));
		}
	}
}
/* Save/Restore Stack */
...
List * simple_vm_savestack ( VM *vm )
{
	...
	while ( vm->nSP  != 0 ) {
		if ( SIMPLE_VM_STACK_ISSTRING ) {
			...
			pList2 = simple_list_newlist_gc(vm->pSimpleState,pList);
			simple_list_addpointer_gc(vm->pSimpleState,pList2,SIMPLE_VM_STACK_READP);
			simple_list_addint_gc(vm->pSimpleState,pList2,SIMPLE_VM_STACK_OBJTYPE);
		}
		SIMPLE_VM_STACK_POP ;
	}
	vm->nSP = nSP ;
