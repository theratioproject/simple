...
#define PARSER_ERROR_MISSPARENTHESES "COMPILER ERROR 6 : Parentheses ')' is required "
#define PARSER_ERROR_MISSBRACKETS "COMPILER ERROR 6 : Brackets ']' is required "
#define PARSER_ERROR_PRENTCLASSNAME "COMPILER ERROR 6 : You need to provide a valid parent class name"
#define PARSER_ERROR_EXPROPERATOR "COMPILER ERROR 6 : Unknown expression operator"
#define PARSER_ERROR_NOCLASSDEFINED "COMPILER ERROR 6 : Specified class is not defined"
#define PARSER_ERROR_VARNAME "COMPILER ERROR 6 : Invalid variable name"
#define PARSER_ERROR_NOCATCH "COMPILER ERROR 6 : 'catch' keyword is missing in try | catch"
#define PARSER_ERROR_SWITCHEXPR "COMPILER ERROR 6 : Error in Switch statement expression"
#define PARSER_ERROR_BRACESNOTCLOSED "COMPILER ERROR 6 : Missing closing brace for the opened block"
#define PARSER_ERROR_NUMERICOVERFLOW "COMPILER ERROR 6 : Numeric Overflow!"
#define PARSER_ERROR_MODULENAME "COMPILER ERROR 6 : Error in module name"
#define PARSER_ERROR_BLOCKREDEFINE "COMPILER ERROR 22 : The block is already defined "
#define PARSER_ERROR_USINGBRACTAFTERNUM "COMPILER ERROR 6 : Using '(' after number"
#define PARSER_ERROR_PARENTLIKESUBCLASS "COMPILER ERROR 6 : The parent class name is identical to class name"
#define PARSER_ERROR_ACCESSSELFREF "COMPILER ERROR 6 : Object reference is out of context"
