...
${OBJECTDIR}/sources/ring_api.o: sources/ring_api.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_api.o sources/ring_api.c

${OBJECTDIR}/sources/ring_codegen.o: sources/ring_codegen.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_codegen.o sources/ring_codegen.c

${OBJECTDIR}/sources/ring_expr.o: sources/ring_expr.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_expr.o sources/ring_expr.c

${OBJECTDIR}/sources/ring_ext.o: sources/ring_ext.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_ext.o sources/ring_ext.c

${OBJECTDIR}/sources/ring_hashlib.o: sources/ring_hashlib.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_hashlib.o sources/ring_hashlib.c

${OBJECTDIR}/sources/ring_hashtable.o: sources/ring_hashtable.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_hashtable.o sources/ring_hashtable.c

${OBJECTDIR}/sources/ring_item.o: sources/ring_item.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_item.o sources/ring_item.c

${OBJECTDIR}/sources/ring_items.o: sources/ring_items.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_items.o sources/ring_items.c

${OBJECTDIR}/sources/ring_list.o: sources/ring_list.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_list.o sources/ring_list.c

${OBJECTDIR}/sources/ring_objfile.o: sources/ring_objfile.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_objfile.o sources/ring_objfile.c

${OBJECTDIR}/sources/ring_parser.o: sources/ring_parser.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_parser.o sources/ring_parser.c

${OBJECTDIR}/sources/ring_scanner.o: sources/ring_scanner.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_scanner.o sources/ring_scanner.c

${OBJECTDIR}/sources/ring_state.o: sources/ring_state.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_state.o sources/ring_state.c

${OBJECTDIR}/sources/ring_stmt.o: sources/ring_stmt.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_stmt.o sources/ring_stmt.c

${OBJECTDIR}/sources/ring_string.o: sources/ring_string.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_string.o sources/ring_string.c

${OBJECTDIR}/sources/ring_vm.o: sources/ring_vm.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vm.o sources/ring_vm.c

${OBJECTDIR}/sources/ring_vmcui.o: sources/ring_vmcui.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmcui.o sources/ring_vmcui.c

${OBJECTDIR}/sources/ring_vmdll.o: sources/ring_vmdll.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmdll.o sources/ring_vmdll.c

${OBJECTDIR}/sources/ring_vmduprange.o: sources/ring_vmduprange.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmduprange.o sources/ring_vmduprange.c

${OBJECTDIR}/sources/ring_vmexit.o: sources/ring_vmexit.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmexit.o sources/ring_vmexit.c

${OBJECTDIR}/sources/ring_vmexpr.o: sources/ring_vmexpr.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmexpr.o sources/ring_vmexpr.c

${OBJECTDIR}/sources/ring_vmfile.o: sources/ring_vmfile.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmfile.o sources/ring_vmfile.c

${OBJECTDIR}/sources/ring_vmfuncs.o: sources/ring_vmfuncs.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmfuncs.o sources/ring_vmfuncs.c

${OBJECTDIR}/sources/ring_vmgc.o: sources/ring_vmgc.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmgc.o sources/ring_vmgc.c

${OBJECTDIR}/sources/ring_vmjump.o: sources/ring_vmjump.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmjump.o sources/ring_vmjump.c

${OBJECTDIR}/sources/ring_vmlistfuncs.o: sources/ring_vmlistfuncs.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmlistfuncs.o sources/ring_vmlistfuncs.c

${OBJECTDIR}/sources/ring_vmlists.o: sources/ring_vmlists.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmlists.o sources/ring_vmlists.c

${OBJECTDIR}/sources/ring_vmmath.o: sources/ring_vmmath.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmmath.o sources/ring_vmmath.c

${OBJECTDIR}/sources/ring_vmoop.o: sources/ring_vmoop.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmoop.o sources/ring_vmoop.c

${OBJECTDIR}/sources/ring_vmos.o: sources/ring_vmos.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmos.o sources/ring_vmos.c

${OBJECTDIR}/sources/ring_vmperformance.o: sources/ring_vmperformance.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmperformance.o sources/ring_vmperformance.c

${OBJECTDIR}/sources/ring_vmrefmeta.o: sources/ring_vmrefmeta.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmrefmeta.o sources/ring_vmrefmeta.c

${OBJECTDIR}/sources/ring_vmstackvars.o: sources/ring_vmstackvars.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmstackvars.o sources/ring_vmstackvars.c

${OBJECTDIR}/sources/ring_vmstate.o: sources/ring_vmstate.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmstate.o sources/ring_vmstate.c

${OBJECTDIR}/sources/ring_vmstrindex.o: sources/ring_vmstrindex.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmstrindex.o sources/ring_vmstrindex.c

${OBJECTDIR}/sources/ring_vmtrycatch.o: sources/ring_vmtrycatch.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmtrycatch.o sources/ring_vmtrycatch.c

${OBJECTDIR}/sources/ring_vmvars.o: sources/ring_vmvars.c
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/ring_vmvars.o sources/ring_vmvars.c
