...
RING_API void * simple_malloc ( size_t size ) ;

RING_API void simple_free ( void *ptr ) ;

RING_API void * simple_calloc ( size_t nitems, size_t size ) ;

RING_API void * simple_realloc ( void *ptr, size_t size ) ;
/* Memory Functions (Ring StateAware) */

RING_API void * simple_state_malloc ( void *pState,size_t size ) ;

RING_API void simple_state_free ( void *pState,void *pMemory ) ;

RING_API void * simple_state_calloc ( void *pState,size_t nitems, size_t size ) ;

RING_API void * simple_state_realloc ( void *pState,void *ptr, size_t size ) ;
