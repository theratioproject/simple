...
**  Add 
*/
#define SIMPLE_VM_STACK_PUSHC pVM->nSP++ ; ring_itemarray_setstring2(pVM->aStack, pVM->nSP, ring_string_get(pVM->pByteCodeIR->aData[1]->data.pString), ring_string_size(pVM->pByteCodeIR->aData[1]->data.pString))
#define SIMPLE_VM_STACK_PUSHN pVM->nSP++ ; ring_itemarray_setdouble(pVM->aStack, pVM->nSP , pVM->pByteCodeIR->aData[1]->data.dNumber)
#define SIMPLE_VM_STACK_PUSHP pVM->nSP++ ; ring_itemarray_setpointer(pVM->aStack, pVM->nSP , pVM->pByteCodeIR->aData[1]->data.pPointer )
/* Note, use SIMPLE_VM_STACK_OBJTYPE to read/write the pointer type */
#define SIMPLE_VM_STACK_TRUE ring_itemarray_setdouble(pVM->aStack,pVM->nSP, 1)
#define SIMPLE_VM_STACK_FALSE ring_itemarray_setdouble(pVM->aStack,pVM->nSP, 0)
#define SIMPLE_VM_STACK_PUSHCVAR ring_itemarray_setstring2(pVM->aStack,pVM->nSP,ring_list_getstring(pVar,3),ring_list_getstringsize(pVar,3))
#define SIMPLE_VM_STACK_PUSHNVAR ring_itemarray_setdouble(pVM->aStack,pVM->nSP,ring_list_getdouble(pVar,3))
#define SIMPLE_VM_STACK_PUSHPVALUE(x) pVM->nSP++ ; ring_itemarray_setpointer(pVM->aStack, pVM->nSP , x )
#define SIMPLE_VM_STACK_PUSHCVALUE(x) pVM->nSP++ ; ring_itemarray_setstring(pVM->aStack, pVM->nSP, x)
#define SIMPLE_VM_STACK_PUSHNVALUE(x) pVM->nSP++ ; ring_itemarray_setdouble(pVM->aStack, pVM->nSP , x)
#define SIMPLE_VM_STACK_SETCVALUE(x) ring_itemarray_setstring(pVM->aStack, pVM->nSP, x)
#define SIMPLE_VM_STACK_SETNVALUE(x) ring_itemarray_setdouble(pVM->aStack, pVM->nSP , x)
#define SIMPLE_VM_STACK_SETPVALUE(x) ring_itemarray_setpointer(pVM->aStack, pVM->nSP , x )
#define SIMPLE_VM_STACK_SETCVALUE2(x,y) ring_itemarray_setstring2(pVM->aStack, pVM->nSP, x,y)
/* Check */
#define SIMPLE_VM_STACK_ISSTRING ring_itemarray_isstring(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_ISNUMBER ring_itemarray_isnumber(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_ISPOINTER ring_itemarray_ispointer(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_ISPOINTERVALUE(x) ring_itemarray_ispointer(pVM->aStack,x)
/* Read */
#define SIMPLE_VM_STACK_READC ring_itemarray_getstring(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_STRINGSIZE ring_itemarray_getstringsize(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_READN ring_itemarray_getdouble(pVM->aStack,pVM->nSP)
#define SIMPLE_VM_STACK_READP ring_itemarray_getpointer(pVM->aStack,pVM->nSP)
...
#define SIMPLE_VM_IR_READC ring_string_get(pVM->pByteCodeIR->aData[1]->data.pString)
#define SIMPLE_VM_IR_READCVALUE(x) ring_string_get(pVM->pByteCodeIR->aData[x]->data.pString)
...
#define SIMPLE_VM_IR_SETCVALUE(x,y) ring_string_set_gc(pVM->pRingState,pVM->pByteCodeIR->aData[x]->data.pString,y)
...
/* Temp Object */
#define SIMPLE_TEMP_OBJECT "ring_temp_object"
#define SIMPLE_TEMP_VARIABLE "ring_sys_temp"
/* Trace */
