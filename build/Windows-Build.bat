...
:builddymodule
	...
	cl.exe /D_USRDLL /D_WINDLL /LD /MT !DY_MODULE_FILES! /I !DY_MODULE_INCLUDE_DIR! /link /DLL /LIBPATH:%~dp0\..\simple\dist\ simple.lib 
	echo cl.exe /D_USRDLL /D_WINDLL /LD /MT !DY_MODULE_FILES! /I !DY_MODULE_INCLUDE_DIR! /link /DLL /LIBPATH:%~dp0\..\simple\dist\ simple.lib 
