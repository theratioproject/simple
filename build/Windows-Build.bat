...
:builddynamicmodules
	...
	if !THERE_IS_VS!=="true" (
		...
		call:getdynamicmodulefiles
		cl.exe /D_USRDLL /D_WINDLL /TC !DYNAMIC_MODULE_FILES! /MT /I !DY_MODULE_INCLUDE_DIR! /link /DLL /OUT:%~dp0\..\modules\dynamic_modules\dist\archiver.dll
	) else (
		if exist "..\modules" (
			cd "..\modules"
