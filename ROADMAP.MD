...
- [ ] use the Catch method in classes to attend to error that occur when class access is in braces
...
- [ ] change all existing module methods and function identifier to with Capital letter instead of small letter
