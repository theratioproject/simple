...
#
#modules/dynamic_modules/makefiles/ $ make -f Makefile-Mac.mk
#
...
clean: 
	cd ../archiver/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../file_savant/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../mathic/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../string_savant/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../networker/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../security/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../simple_sqlite/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../systemic/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../core_dynamic_module/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
	cd ../fulltick/ && $(MAKE) -f Makefile-Mac.mk ARC_FLAG=$(ARC_FLAG) ARC=$(ARC)
...
#
#File-Name : Makefile-Mac-{Compiler}-{WindowsVersion}.mk
#
#e.g Makefile-Mac-cygwin-Windows8.mk
#
