...
${CND_DISTDIR}/${CND_PLATFORM}/libarchiver.${CND_DLIB_EXT}: $(OBJECTFILES) $(SIMPLE_OBJECTFILES)
	$(CC) -shared $(ARC_FLAG) -o $(CND_DISTDIR)/$(CND_PLATFORM)/libarchiver.$(CND_DLIB_EXT) $(SIMPLE_OBJECTFILES) $(OBJECTFILES)  ${OBJECTFILES}
