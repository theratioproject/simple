...
CFLAGS= -c -fpic -g -w
FLTKFlAGS=
LDFLAGS= `fltk-config --use-forms --use-gl --use-glut --use-images --ldstaticflags --cxxflags`
LDFLAGS:= $(LDFLAGS) 
...
clean: 
	g++ -shared -fpermissive -w -fPIC $(ARC_FLAG) -I$(DESTDIR)$(PREFIX)/include -I$(DESTDIR)$(PREFIX)/include/FL/images ${FLTKFLAGS}  -fvisibility-inlines-hidden -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D_THREAD_SAFE -D_REENTRANT -o '$(CND_DISTDIR)/$(CND_PLATFORM)/libfulltick.$(CND_DLIB_EXT)' $(FULLTICK_FILES)  $(LDFLAGS) $(LDLIBSOPTIONS)
