...
#
#cd to the modules/dynamic_modules/libsimple_sqlite/  folder. 
#
...
#
#modules/dynamic_modules/libsimple_sqlite/ $ make -f Makefile-Windows.mk
...
LDLIBSOPTIONS=../../../simple/dist/libsimple.dll -sqlite3
...
${OBJECTDIR}/libsimple_sqlite.o: libsimple_sqlite.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} ${OBJECTDIR}/*d
	$(COMPILE.c) $(ARC_FLAG) -o ${OBJECTDIR}/libsimple_sqlite.o libsimple_sqlite.c  
