...
{
	sqlite3* sqlite312918;	
	SIMPLE_API_RETCPOINTER(sqlite3,"SMOOTHC_SQLITE");
}

SIMPLE_BLOCK(init_sqlite3_stmt) 
{
	sqlite3_stmt* sqlite3_stmt27215;	
	SIMPLE_API_RETCPOINTER(sqlite3_stmt,"SMOOTHC_SQLITE");
}

SIMPLE_BLOCK(init_sqlite3_context) 
{
	sqlite3_context* sqlite3_context10170;	
	SIMPLE_API_RETCPOINTER(sqlite3_context,"SMOOTHC_SQLITE");
}
