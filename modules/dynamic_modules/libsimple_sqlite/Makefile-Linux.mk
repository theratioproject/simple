#Build LIBSIMPLE_SQLITE dynamic module for LINUX
#
...
#
#user $ cd modules/dynamic_modules/libsimple_sqlite/
#
...
#
#simple/src/makefiles/libsimple_sqlite/ $ make -f Makefile-Linux.mk
...
${CND_DISTDIR}/${CND_PLATFORM}/libsimple_sqlite.${CND_DLIB_EXT}: $(OBJECTFILES)
	$(CC) -shared $(ARC_FLAG) $(SIMPLE_OBJECTFILES) $(OBJECTFILES) -sqlite3 -o $(CND_DISTDIR)/$(CND_PLATFORM)/libsimple_sqlite.$(CND_DLIB_EXT) 

$(OBJECTDIR)/libsimple_sqlite.o: libsimple_sqlite.c
	mkdir -p $(OBJECTDIR)
	$(CC) $(ARC_FLAG) $(CFLAGS) libsimple_sqlite.c 
	mv libsimple_sqlite.o $(OBJECTDIR)
