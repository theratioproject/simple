...
#directory to the modules/dynamic_modules/simple_sqlite/ folder 
#
...
${CND_DISTDIR}/${CND_PLATFORM}/libsimple_sqlite.${CND_DLIB_EXT}: $(OBJECTFILES)
	$(CC) -shared $(ARC_FLAG) -o $(CND_DISTDIR)/$(CND_PLATFORM)/libsimple_sqlite.$(CND_DLIB_EXT) $(OBJECTFILES) $(LDLIBSOPTIONS)
