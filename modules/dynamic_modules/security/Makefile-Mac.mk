...
#directory to the modules/dynamic_modules/security/ folder 
#
...
LDLIBSOPTIONS=../../../simple/dist/libsimple.${CND_DLIB_EXT} -lcrypto -lssl

${CND_DISTDIR}/${CND_PLATFORM}/libsecurity.${CND_DLIB_EXT}: $(OBJECTFILES)
	$(CC) -shared $(ARC_FLAG) -o $(CND_DISTDIR)/$(CND_PLATFORM)/libsecurity.$(CND_DLIB_EXT) $(OBJECTFILES) $(LDLIBSOPTIONS)

$(OBJECTDIR)/security.o: security.c
	mkdir -p $(OBJECTDIR)
	$(CC) $(ARC_FLAG) $(CFLAGS) security.c
