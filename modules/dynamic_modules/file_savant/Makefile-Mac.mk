...
#directory to the modules/dynamic_modules/file_savant/ folder 
#
...
${CND_DISTDIR}/${CND_PLATFORM}/libfile_savant.${CND_DLIB_EXT}: $(OBJECTFILES)
	$(CC) -shared $(ARC_FLAG) -o $(CND_DISTDIR)/$(CND_PLATFORM)/libfile_savant.$(CND_DLIB_EXT) $(OBJECTFILES) $(LDLIBSOPTIONS)
