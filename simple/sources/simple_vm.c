...
SIMPLE_API void simple_vm_cgi_showerrormessage ( VM *vm,const char *cStr )
{
	...
	List *list  ;
	const char *cFile  ;
	printf("%i | %s | %s <br />",simple_list_getsize(vm->sState->files_list),simple_list_getstring(vm->sState->files_list,1),simple_list_getstring(vm->sState->files_list,simple_list_getsize(vm->sState->files_list)));
	/* Print the Error Message */
