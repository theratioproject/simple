...
void display_help(){
    ...
    printf("  -k --show-tokens	outputs the tokens in the source file.\n");
    printf("  -t --time		shows time after execution.\n");
    printf("  -c --case-neutral	make simple-lang case insensitive 'a=A'.\n");
    printf("  -i -cgi --web		prepare simple for web development.\n");
    printf("  -v --version		print simple version and exit.\n");
